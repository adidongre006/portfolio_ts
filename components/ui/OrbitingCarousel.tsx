...
// {
// id: 8,
// name: "Richard Feynman",role: "Theoretical Physicist",
...
<div className="flex flex-col items-center p-4 relative min-h-[400px] bg-white dark:bg-black transition-colors duration-300 border-2 border-blue-500 rounded-2xl mb-9">
<div
...
className="z-10 bg-white dark:bg-gray-950 backdrop-blur-sm shadow-xl dark:shadow-2xl dark:shadow-gray-900/50 rounded-xl p-3 md:p-4 w-48 md:w-52 text-
center border border-gray-100 dark:border-gray-800"
>
<motion.img
...
>
<h2 className="mt-2 text-base md:text-lg font-bold pl-5 text-gray-800 dark:text-white">
...
<button
 ...
 className="px-4 py-1 text-sm rounded-full bg-indigo-600 text-white hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600 transition-
colors">
Connect us 
</button>
</Link>
